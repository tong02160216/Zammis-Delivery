...
POSE_CONFIGS = {
    "strong_action": {
        ...
        "tolerance": 140,  # 容差范围（像素），关键点在此范围内都算正确
        "head_tolerance": 100,  # 头部特殊容差范围
        "wrist_tolerance": 140,  # 手腕特殊容差范围
    ...
    "RiseHighWithTwoHand": {
        ...
        "tolerance": 100,  # 容差范围（像素）
        "head_tolerance": 100,  # 头部特殊容差范围
        "wrist_tolerance": 100,  # 手腕特殊容差范围
    ...
    "CompareHearts": {
        ...
        "landmarks": {
            ...
            13: [384, 216],    # 左肘
            14: [896, 216],    # 右肘
            15: [538, 180],    # 左手腕（头部附近比心）
            16: [742, 180],    # 右手腕（头部附近比心）
            23: [512, 432],    # 左臀
            24: [768, 432],    # 右臀
            25: [486, 576],    # 左膝
            26: [794, 576],    # 右膝
